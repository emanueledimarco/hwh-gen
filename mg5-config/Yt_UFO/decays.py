...
Decay_H = Decay(name = 'Decay_H',
                particle = P.H,
                partial_widths = {(P.t,P.t__tilde__):'((3*MH**2*yt**2 + 9*cu*MH**2*yt**2 + (27*cu**2*MH**2*yt**2)/4. - 12*MT**2*yt**2 - 36*cu*MT**2*yt**2 - 27*cu**2*MT**2*yt**2)*cmath.sqrt(MH**4 - 4*MH**2*MT**2))/(16.*cmath.pi*abs(MH)**3)',
