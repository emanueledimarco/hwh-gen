...
process.source = cms.Source("LHESource",
    ...
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/user/emanuele/hwh/lhe/pp-tjww-2l_unweighted_events.lhe'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:hwh-RunIIAutumn18GENSIM.root'),
