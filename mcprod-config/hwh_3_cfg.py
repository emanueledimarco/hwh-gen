...
# with command line options: --filein file:hwh-RunIIAutumn18MiniAOD-FullSim.root --fileout file:hwh-RunIIAutumn18NanoAODv4_FullSim.root -s NANO --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --no_exec --conditions 102X_upgrade2018_realistic_v19 --era Run2_2018,run2_nanoAOD_102Xv1 --customise_commands process.particleLevelSequence.remove(process.genParticles2HepMCHiggsVtx);process.particleLevelSequence.remove(process.rivetProducerHTXS);process.particleLevelTables.remove(process.HTXSCategoryTable) --python_filename hwh_3_cfg.py -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:hwh-RunIIAutumn18MiniAOD-FullSim.root'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:hwh-RunIIAutumn18NanoAODv4_FullSim.root'),
